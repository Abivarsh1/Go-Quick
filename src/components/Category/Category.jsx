    ...
    return (
        <div className="lg:container mx-auto">
            <div className="grid grid-cols-2">
                ...
                <div className="max-w-[550px] w-full min-h-[660px]
                 h-full bg-[#fbf3ee] rounded-l-2xl flex flex-col justify-between pt-4 items-center">

                    <div className="flex items-center justify-center flex-col space-y-3">
                        <h4 className="text-lg text-[#1b1b1b] font-medium capitalize">Fruits & veggies</h4>
                        <span className="text-sm text-[#595959 ] font-normal">2 items</span>
                    </div>

                    <div className="w-full">
                        <img className="w-full object-cover" src="src/assets/popular/popular_1.png" alt="fruits & veggies" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-6">

                    {
                        ...
                        categories?.map((item, index) => {
                            ...
                            return (
                                <div key={index} className={`mx-w-[350px] w-full min-h-[320px]
